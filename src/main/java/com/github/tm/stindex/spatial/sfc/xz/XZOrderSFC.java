...
public class XZOrderSFC implements GridIndex {
  ...
  public ByteArray getIndex(double[] values) {
    ...
    byte[] index = sequenceCode(minValues, length);
  ...
  public RangeDecomposition decomposeRange(
    ...
    final ArrayList<ByteArrayRange> result =
        (ArrayList<ByteArrayRange>) ByteArrayRange.mergeIntersections(ranges, ByteArrayRange.MergeOperation.UNION);
