 ...
 * */
package com.github.tm.stindex.spatial.sfc.tiered;
...
import com.github.tm.stindex.spatial.sfc.binned.BinnedSFCUtils;
import com.github.tm.stindex.ByteArrayRange;
import com.github.tm.stindex.ByteArrayUtils;
import com.github.tm.stindex.FloatCompareUtils;
import com.github.tm.stindex.HierarchicalNumericIndexStrategy;
import com.github.tm.stindex.IndexMetaData;
import com.github.tm.stindex.IndexUtils;
import com.github.tm.stindex.InsertionIds;
import com.github.tm.stindex.Mergeable;
...
import com.github.tm.stindex.SinglePartitionInsertionIds;
...
public class TieredSFCIndexStrategy implements HierarchicalNumericIndexStrategy {
  ...
  public QueryRanges getQueryRanges(
    ...
    for (int sfcIndex = orderedSfcs.length - 1; sfcIndex >= 0; sfcIndex--) {
      ...
      final GridIndex sfc = orderedSfcs[sfcIndex];
  ...
  protected static SinglePartitionInsertionIds decomposeRangesForEntry(
    ...
    final byte[] tierAndBinId =
        tierId != null ? ByteArrayUtils.combineArrays(new byte[] {tierId}, index.getBinId())
            : index.getBinId();
    final RangeDecomposition rangeDecomp = sfc.decomposeRange(index, DEFAULT_MAX_RANGES);
  ...
  public byte[] toBinary() {
    ...
    for (final GridIndex sfc : orderedSfcs) {
  ...
  public void fromBinary(final byte[] bytes) {
    ...
    orderedSfcs = new GridIndex[numSfcs];
    ...
    for (int i = 0; i < numSfcs; i++) {
      ...
      orderedSfcs[i] = (GridIndex) PersistenceUtils.fromBinary(sfc);
    }
