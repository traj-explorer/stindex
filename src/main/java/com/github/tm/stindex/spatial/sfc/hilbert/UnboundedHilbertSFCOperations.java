...
public class UnboundedHilbertSFCOperations implements HilbertSFCOperations {
  ...
  @Override
  public byte[] convertToHilbert(long[] coordinates, CompactHilbertCurve compactHilbertCurve, int dimNum, int res) {
    return new byte[0];
  }
  ...
  @Override
  public long[] indicesFromHilbert(byte[] hilbertValue, CompactHilbertCurve compactHilbertCurve, int dimNum, int res) {
    return new long[0];
  }
