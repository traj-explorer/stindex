...
public class STByteArray extends ByteArray {
  ...
  public SpatialByteArray getSpatialIndex() {
    byte[] spatialBytes = new byte[bytes.length - frontLen - backLen];
  ...
  public String toString() {
    ...
    ByteArray spatialIndex = new SpatialByteArray(spatialBytes, 0);
